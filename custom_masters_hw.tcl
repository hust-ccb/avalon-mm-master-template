...
set_module_property GROUP "Master Template"
...
add_parameter USER_DATA_WIDTH Integer 32 "Width of the data path"
set_parameter_property USER_DATA_WIDTH VISIBLE true
set_parameter_property USER_DATA_WIDTH DISPLAY_NAME "User Data Width"
set_parameter_property USER_DATA_WIDTH GROUP "Avalon-MM Master Properties"
set_parameter_property USER_DATA_WIDTH AFFECTS_PORT_WIDTHS true
set_parameter_property USER_DATA_WIDTH ALLOWED_RANGES {8 16 32 64 128 256 512 1024}

add_parameter AVALON_DATA_WIDTH Integer 32 "Width of the data path"
set_parameter_property AVALON_DATA_WIDTH VISIBLE true
set_parameter_property AVALON_DATA_WIDTH DISPLAY_NAME "Avalon Data Width"
set_parameter_property AVALON_DATA_WIDTH GROUP "Avalon-MM Master Properties"
set_parameter_property AVALON_DATA_WIDTH AFFECTS_PORT_WIDTHS true
set_parameter_property AVALON_DATA_WIDTH ALLOWED_RANGES {8 16 32 64 128 256 512 1024}
...
set_parameter_property FIFO_DEPTH ALLOWED_RANGES {4 8 16 32 64 128 256 512}
...
set_parameter_property FIFO_DEPTH_LOG2 ALLOWED_RANGES {2:9}
...
add_interface_port user user_read_clk export Input 1
...
add_interface_port user user_write_clk export Input 1
...
proc elaborate_me {}  {
  ...
  set the_user_data_width [get_parameter_value USER_DATA_WIDTH]
  set the_avalon_data_width [get_parameter_value AVALON_DATA_WIDTH]
  set the_byteenable_width [expr {$the_avalon_data_width / 8} ]
  ...
  set_port_property user_buffer_input_data WIDTH $the_user_data_width
  set_port_property user_buffer_output_data WIDTH $the_user_data_width
  set_port_property master_address WIDTH $the_address_width
  set_port_property master_byteenable WIDTH $the_byteenable_width
  set_port_property master_readdata WIDTH $the_avalon_data_width
  set_port_property master_writedata WIDTH $the_avalon_data_width
  ...
  if { $the_master_direction == 0 } { 
    ...
    set_port_property user_read_clk TERMINATION false   
  	set_port_property user_write_buffer TERMINATION true
    set_port_property user_write_clk TERMINATION true
    ...
    send_message Info "Avalon Master Side Set The FIFO Depth Which Is Dependent on Write Side Of The FIFO.."
  } else { 
  ...
  set_port_property user_read_clk TERMINATION true
	set_port_property user_write_buffer TERMINATION false
  set_port_property user_write_clk TERMINATION false
  ...
  send_message Info "USER Side Set The FIFO Depth Which Is Dependent on Write Side Of The FIFO."
  }
